  ...
  return (
    <div className={cn("text-base sm:text-xl md:text-3xl lg:text-5xl font-bold text-center", className)}>
      ...
      <motion.span
        ...
        className={cn("inline-block rounded-sm w-[4px] h-4 md:h-6 lg:h-10 bg-violet-500", cursorClassName)}
      ></motion.span>
    </div>
  )
}
  ...
  return (
    <div className={cn("flex space-x-1 my-6", className)}>
      ...
      <motion.span
        ...
        className={cn("block rounded-sm w-[4px]  h-4 sm:h-6 xl:h-12 bg-violet-500", cursorClassName)}
      ></motion.span>
    </div>
  )
}
